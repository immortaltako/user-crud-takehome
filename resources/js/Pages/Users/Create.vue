<template>
  <div class="flex flex-col items-center justify-center min-h-screen">
    <div class="w-full lg:w-2/3">
      <h1 class="text-4xl font-bold text-gray-800 my-8">Add New User</h1>
      ...
      <div class="bg-white shadow-md rounded my-6 p-8">
        <form @submit.prevent="addUser">
          ...
          <div class="mb-6">
            ...
            <input v-model="user.password" type="password" id="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" required>
          </div>
